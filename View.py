...
logo=(f'''{B}{E}========================================{E}
  ...
  {E}𝐓ʜɪ𝐬 𝐒ᴄʀɪᴘᴛ 𝐈𝐬 𝐎ᴡɴᴇᴅ 𝐁ʏ Albertjaves {B}
       
         {G}[+] 𝐃ᴇᴠᴇʟᴏᴘᴇʀ -> {B} Albertjaves                        
   
         {G}[+] 𝐓ᴇʟᴇɢʀᴀᴍ 𝐔sᴇʀɴᴀᴍᴇ -> {B}@carolin_9899    
        
    	 {G}[+] 𝐓ᴇʟᴇɢʀᴀᴍ 𝐂ʜᴀɴɴᴇʟ -> {B}@carolin_9899  
...
try:
    ...
    print(f'{G}[√]𝐒ᴛᴀʀᴛᴇᴅ | 𝐖ᴀɪᴛ 𝐅ᴇᴡ 𝐒ᴇᴄᴏɴᴅs 𝐓ᴏ 𝐑ᴜɴ 𝐓ʜʀᴇᴀᴅs to Parvej Tools')
